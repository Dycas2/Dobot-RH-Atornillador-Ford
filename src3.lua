while true do
	...
	local indice_actualBKP1 = indice_tornilloBK1
	local indice_actualBKP2 = indice_tornilloBK2
	...
	if indice_actualBKP1 >= MAX_TORBAK then
		...
		if recargaBKP1 == 1 then
			indice_actualBKP1 = 0
			SetGlobalVariable("indice_tornilloBK1", indice_actualBKP1)
	...
	if indice_actualBKP2 >= MAX_TORBAK then
		...
		if recargaBKP2 == 1 then
			indice_actualBKP2 = 0
			SetGlobalVariable("indice_tornilloBK2", indice_actualBKP2)
